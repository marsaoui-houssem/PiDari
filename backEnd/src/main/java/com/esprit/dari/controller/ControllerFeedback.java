...
public class ControllerFeedback {
	...
	// ADD A FEEDBACK : http://localhost:8081/SpringMVC/servlet/addfeedback/1/1
		...
		@ResponseBody
		public String AddFeedback(@RequestBody Feedback f,@PathVariable("idUser") int idUser,
		...
		// CALCULATE THE TOTAL RATE OF AN AD :
		// http://localhost:8081/SpringMVC/servlet/flag-feed/1
		@PostMapping(value = "/flag-feed/{idfeed}")
		@ResponseBody
		public String getFlag(@PathVariable("idfeed") int idfeedback) {

			return ifeed.FlagAReview(idfeedback);
		}
