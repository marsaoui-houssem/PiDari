...
public class Sell {
	...
	public User getUser_sell() {
		return user_sell;
	}

	public void setUser_sell(User user_sell) {
	...
	public Sell(String ad_title, float bidPrice, String ownerLastName, String ownerFirstName, String buyerFirstName,
			String buyerLastName, Date bidDate, SellContract contract, User user_sell, Ad ad_sell) {
		super();
		Ad_title = ad_title;
		BidPrice = bidPrice;
		OwnerLastName = ownerLastName;
