...
public class rent {
	...
	public UserDari getUser_rent() {
		return user_rent;
	}

	public void setUser_rent(UserDari user_rent) {
	...
	public rent(String ad_name, String owner_first_name, String owner_last_name, String buyer_first_name,
			String buyer_last_name, float total_Price, Date start_Date, Date finish_Date, UserDari user_rent, Ad ad_rent,
